...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/solders-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/solders-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `solders` available on your platform:
...
```
pixi search solders --channel conda-forge
```
